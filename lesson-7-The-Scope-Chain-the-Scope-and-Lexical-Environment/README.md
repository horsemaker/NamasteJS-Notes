...
- When we run this program, a global execution context is created and pushed onto the call stack
    <br><img src="images/visual1.png" width=300px>
...
<br><img src="images/visual2.png" width=300px>
...
<br><img src="images/visual3.png" width=300px/>
...
<br><img src="images/visual4.png" width=300px/>
...
<br><img src="images/visual5.png" width=300px/>
...
<br><img src="images/code6.png" width=300px/>
...
- As it found `b`it will give it back to local memory of `c()`, execute the statement and print the value on console.<br>
    - <img src="images/img5.PNG" width=300px><br>
...
- So, practically function `c()` has access to all the variables throughout the code.<br>
    - <img src="images/img10.PNG" width=300px><br>

#### Resources
- [The Scope Chain, Scope and Lexical Environment](https://www.youtube.com/watch?v=uH-tVP8MUs8&list=PLlasXeu85E9cQ32gLCvAvr9vNaUccPVNP&index=8)
